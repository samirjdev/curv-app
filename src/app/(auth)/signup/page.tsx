  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      ...
      <Card className="w-[350px] border-none shadow-2xl bg-white/90 backdrop-blur-sm">
        <CardHeader>
          <CardTitle className="font-rajdhani text-2xl font-semibold">Start your journey</CardTitle>
          <CardDescription className="font-rajdhani">Stay ahead of the Curv starting now</CardDescription>
        </CardHeader>
